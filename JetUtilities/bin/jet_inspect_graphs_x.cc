...
int main(int argc,char** argv)
{
            ...
            for (unsigned int ivar=0;ivar<variables.size();ivar++) {
                ...
                while ((g=gl.next_object(indices))) {
                    ...
                    if (0==mg) {
                        ...
                        double legymax = legymin - (nleglabels)*0.065;
    ...
    if (overlay) {
        c = new TCanvas(mg->GetName(),mg->GetName(),1000,800);
        ...
        string xtitle,string ytitle,string refpt)
{
    ...
    if (pos!=string::npos) {
        ...
        if (xtitle.empty()) {
            ...
            if (xstr=="npv")      xtitle="NPV";
            if (xstr=="NPU")      xtitle="NPU";
            if (xstr=="TrueNPU")  xtitle="TrueNPU";
        }
    }
