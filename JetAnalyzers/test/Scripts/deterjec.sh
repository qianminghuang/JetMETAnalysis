...
jet_response_fitter_x -input ../jra_L1.root -output ../jra_L1_f.root

#------- derive the L3 correction (will be merged by next step with L2 correction) ------
jet_l3_correction_x -input ../jra_L1_f.root -era EcalMultifitHCALMethod3 -algs ak4pfHLTl1 ak4caloHLTl1 ak8pfHLTl1 ak8caloHLTl1 -output ../l3.root

#------- derive the L2 correction merged with L3 correction -------------
jet_l2_correction_x -input ../jra_L1_f.root -l3input ../l3.root -output ../l2.root -era EcalMultifitHCALMethod3 -algs ak4pfHLTl1 ak4caloHLTl1 ak8pfHLTl1 ak8caloHLTl1
